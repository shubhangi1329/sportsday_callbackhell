...
/*
We define a function called LongJump, which takes three parameters: score, callbackFnc, and nextCallbackFnc.
*/
...
function AwardCeremony(score) {
  ...
  console.log(
    `${sorted[0][0]} came first with ${sorted[0][1]} points. ${sorted[1][0]} came second with ${sorted[1][1]} points. ${sorted[2][0]} came third with ${sorted[2][1]} points.`
  );
}
